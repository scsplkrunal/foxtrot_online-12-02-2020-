...
$table = array('PermrepFTO','1099FTO','BranchesFTO','ClearingFTO','ClientsFTO','CompanyFTO','ProdTypeFTO','tradesFTO');
$table_original = array('permrep','1099','branches','clearing','clients','company','prodtype','trades');
...
foreach($company_array as $com_key=>$com_val)
{
    ...
    foreach($table as $tbl_key=>$tbl_val){
        ...
        $db = 'denis_test';//$company.'_jjixgbv9my802728';
