...
<div class="container">
	<div class="row justify-content-center mt-3 d-none d-md-flex">
		<div class="col-6" style="text-align: center;">
			...
			echo "<img src='lib/logos/{$comapny_name}.png' alt='logo' class='logo logo_loginbox'>";
			?>
		</div>
	</div>
	...
	<div class="card card-container">
		...
		<form id="log_in_form" class="form-signin mb-0">
			...
			<input name="username_or_email" type="text" class="form-control" placeholder="Username"
