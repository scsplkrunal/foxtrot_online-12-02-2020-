...
<div class="container-fluid">
	<div class="row">
		...
		<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4" style="flex: 0 0 87.333333%;max-width: 87.333333%;">
            ...
            if(isset($get_configuration['display_licenses_report']) && $get_configuration['display_licenses_report']==1)
            {
            ?>
			
            <?php
            if(isset($get_configuration['display_commission_hold_report']) && $get_configuration['display_commission_hold_report']==1)
            {?>
             <div class="row">   
                <div class='col-sm-5'>
                    <div class="row">
                        ...
                        <div class='col-sm-6' style="cursor: pointer;" id="trades_on_hold" onclick="open_currentreport_box(this.id);">
        					<div class='alert rp_section alert-info'>
        						<strong>Commissions on Hold</strong>
        					</div>
        				</div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class='col-sm-6'>
                    <div class="row">
                        ...
                        <div class='col-sm-6' style="cursor: pointer;" id="ytd_earnings" onclick="open_currentreport_box(this.id);">
        					<div class='alert rp_section alert-info'>
        						<strong>Year to Date Earnings</strong>
        					</div>
        				</div>
            ...
            <div class="row">
                <div class='col-sm-4'>
                    <div class="row">
                        <div class='col-sm-12' style="cursor: pointer;" id="client_account_list" onclick="open_currentreport_box(this.id);">
        					<div class='alert rp_section alert-warning1 rp_active'>
        						<strong>Client Account List</strong>
        					</div>
        				</div>
                ...
                <div class='col-sm-4'>
                    <div class="row">
                        <div class='col-sm-12' style="cursor: pointer;" id="adjustments" onclick="open_currentreport_box(this.id);">
        					<div class='alert rp_section alert-info'>
        						<strong>Adjustments</strong>
        					</div>
        				</div>
