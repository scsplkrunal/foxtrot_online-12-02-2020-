<?php
//echo 'Welcome'; phpinfo();exit;
error_reporting(E_ALL);
$mysqli = new mysqli("localhost", "demo_foxtrot", "demo_foxtrot", "demo_foxtrot");
...
// Path to dbase file
$db_path = "lifemark/db/permrep.DBF";

//$sql = "COPY TO permrep.dbf TYPE FOX2X ";
//print_r($mysqli->query($sql));exit;
